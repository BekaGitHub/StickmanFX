 ...
 * @author Beka
 */
public class LeftWrist3D extends PartStickman3D
{
    ...
    public LeftWrist3D(Part3D leftForeArmFX)
    {
        ...
        ((LeftForeArm3D)leftForeArmFX).getLeftForeArmGroup().getChildren().add(leftWristGroup);

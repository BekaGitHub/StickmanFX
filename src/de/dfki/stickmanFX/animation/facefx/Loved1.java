...
public class Loved1 extends AnimationFX {
    ...
    public void playAnimation() {
        ...
        mAnimationPartFX.add(new AnimationContent(mStickmanFX.mLeftEyeFX, "shape", "LOVED1"));
        mAnimationPartFX.add(new AnimationContent(mStickmanFX.mRightEyeFX, "shape", "LOVED1"));

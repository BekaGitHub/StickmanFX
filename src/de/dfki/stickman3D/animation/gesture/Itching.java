...
public class Itching extends Animation3D {
	...
	public void playAnimation() {
		...
		mAnimationPartFX.add(new AnimationContent(mStickmanFX.mLeftUpperArm, "zrotate", -25));
		mAnimationPartFX.add(new AnimationContent(mStickmanFX.mLeftForeArm, "rotate", -35));
		mAnimationPartFX.add(new AnimationContent(mStickmanFX.mLeftForeArm, "zrotate", 65));
